...
constructor(myenemyname:string){
...
do{
    ...
    if(startmatch.options === "attack") attack()
    if (startmatch.options === "increase health") increasehealth()
    if (startmatch.options === "run for life") runForLife()    
